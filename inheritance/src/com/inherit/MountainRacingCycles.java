...
public class MountainRacingCycles extends MountainCycles {

	private boolean GPS;
	private String light;
	private String speedBooster;

	public MountainRacingCycles() {
		super();
		System.out.println("---Default Constructor of MountainRacer Cycle------");
		// TODO Auto-generated constructor stub
	}

	public MountainRacingCycles(String wheels, int seatLevel, double price, String brand, int noOfGears, double speed,
			boolean gPS, String light, String speedBooster) {
		super(wheels, seatLevel, price, brand, noOfGears, speed);
		System.out.println("---Parameterized Constructor of Mountain Racer Cycle------");
		this.GPS = gPS;
		this.light = light;
